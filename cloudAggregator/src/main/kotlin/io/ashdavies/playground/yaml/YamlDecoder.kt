...
internal class YamlDecoder(override val serializersModule: SerializersModule, string: String) : AbstractDecoder() {
    ...
    override fun decodeElementIndex(descriptor: SerialDescriptor): Int = when (lineSequence.hasNext()) {
    ...
    private fun hasValidToken(): Boolean = currentToken != TOKEN_DOCUMENT && currentToken.isNotEmpty()
}
